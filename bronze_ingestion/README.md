...
This folder defines all source code for the 'bronze_ingestion' pipeline:
...
* Take a look at the sample under "sample_users_bronze_ingestion.py" to get familiar with the syntax.

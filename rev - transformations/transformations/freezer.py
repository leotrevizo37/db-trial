...
@dp.materialized_view(name="mv_cuartos_congelacion", comment="Cooler rooms: temperature window + current stats + OperationId")
def mv_cuartos_congelacion():
    base = spark.read.table("trial.silver.freezer_reads")

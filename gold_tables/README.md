...
This folder defines all source code for the 'gold_tables' pipeline:
...
* Take a look at the sample under "sample_users_gold_tables.py" to get familiar with the syntax.

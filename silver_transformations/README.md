...
This folder defines all source code for the 'silver_transformations' pipeline:
...
* Take a look at the sample under "sample_users_silver_transformations.sql" to get familiar with the syntax.
